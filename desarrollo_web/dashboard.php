...
// Aquí puedes agregar el contenido de la página de inicio para usuarios logueados
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3 fw-semibold"><?php echo $user_name; ?></p>
                ...
                <a class="dropdown-item" href="logout.php"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Cerrar Sesión</a>
              </div>
            </li>
          </ul>
